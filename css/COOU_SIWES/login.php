    ...
    <div class="popup-header">
        ...
        <div class="well-new">
          <div class="form-group has-feedback">
            ...
            <input name="username" id="username" class="form-control" placeholder="Username" type="text" required="required">
            <i class="icon-users form-control-feedback"></i>
          </div>

          <div class="form-group has-feedback">
            <label>Password <label class="glyphicon glyphicon-lock"></label></label>
            <input name="password" id="password" class="form-control" placeholder="Password" type="password" required="required">
