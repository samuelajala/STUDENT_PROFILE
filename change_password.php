...
<div class="jumbotron-new">
  ...
  <form role="form" action="" method="post">
    <div class="form-group-new">
      <label for="reg_num" class="ul_text">Current Password:</label>
      <input class="group-control-new" name="current_pass" type="text" value="<?php echo $password; ?>">
    </div>
          <div class="form-group-new">
            <label for="std_sur" class="ul_text">New Password:</label>
            <input class="" name="std_password1" type="password">
          </div>
          <div class="form-group-new">
            <label for="std_FN" class="ul_text">Confirm Password:</label>
